...
.EXAMPLE
    Create-SPAppManagementServiceApp.ps1 -DatabaseServer SP16_SQL -DatabaseName "SP16_ServiceApp_SubscriptionSettingsService"
    Create-SPAppManagementServiceApp.ps1 -DatabaseServer SP16_SQL -DatabaseName "SP16_ServiceApp_SubscriptionSettingsService" -ServiceAppName "Subscription Service"
    Create-SPAppManagementServiceApp.ps1 -DatabaseServer SP16_SQL -DatabaseName "SP16_ServiceApp_SubscriptionSettingsService" -ServiceAppName "Subscription Service" -AppPoolName "Existing AppPool Shared"
    Create-SPAppManagementServiceApp.ps1 -DatabaseServer SP16_SQL -DatabaseName "SP16_ServiceApp_SubscriptionSettingsService" -ServiceAppName "Subscription Service" -AppPoolName "New AppPool Subscription" -ManagedAccount "DEV\SP_Services"
